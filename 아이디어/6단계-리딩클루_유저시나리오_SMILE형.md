# 리딩크루(ReadingCrew) — SMILE형 탐구 독서 플랫폼 · 유저 시나리오

> **"책을 통해 진짜 문제를 찾고, 사람을 모아 함께 해결한다."**
>
> aicareerpath.co.kr이 "진로 정보의 민주화"라면,
> 리딩크루는 **"문제 발견과 해결의 민주화"**다.
...
| 비교 항목 | AI CareerPath | ReadingCrew |
|----------|:---:|:---:|
...
```mermaid
mindmap
  root((리딩크루<br/>SMILE형의<br/>차별적 가치))
    병렬 독서
      같은 주제 다른 시각
      교차 관점 자연 발생
      "내 책에서는 이랬는데"
