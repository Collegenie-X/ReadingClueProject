# 리딩클루(ReadingClue) 화면 설계서 & AI Agent 설계서
...
graph TD
    ...
    G --> G1["토스트: '리딩클루는 서로<br/>존중하는 대화를 지향합니다'"]
...
*이 문서는 리딩클루(ReadingClue)의 화면 설계서와 AI Agent 설계서를 정의합니다.*
